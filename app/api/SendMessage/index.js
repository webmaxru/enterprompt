...
module.exports = async function (context, req) {
  ...
  // Generated by Copilot: Updated to use getChatCompletions with chat message format
  ...
  let q = result.choices[0].message.content;
  ...
  const completion = await openAIClient.getChatCompletions(
    ...
    [
      { role: 'system', content: 'You are a helpful assistant that provides contextual answers based on search results and chat history.' },
      { role: 'user', content: prompt }
    ],
    {
      maxTokens: 1024,
